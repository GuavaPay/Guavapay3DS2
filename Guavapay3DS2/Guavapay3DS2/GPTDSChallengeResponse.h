...
/**
 The `GPTDSACSUIType` enum defines the type of UI to be presented.
 */
typedef NS_ENUM(NSInteger, GPTDSACSUIType) {
    
    /// No UI associated with the response.
    GPTDSACSUITypeNone = 0,
    
    /// Text challenge response UI.
    GPTDSACSUITypeText = 1,
    
    /// Single-select challenge response UI.
    GPTDSACSUITypeSingleSelect = 2,
    
    /// Multi-select challenge response UI.
    GPTDSACSUITypeMultiSelect = 3,
    
    /// Out Of Band challenge response UI.
    GPTDSACSUITypeOOB = 4,
    
    /// HTML challenge response UI.
    GPTDSACSUITypeHTML = 5,
};
...
@property (nonatomic, readonly) GPTDSACSUIType acsUIType;
...
@property (nonatomic, readonly, nullable) NSArray<id<GPTDSChallengeResponseSelectionInfo>> *challengeSelectInfo;
...
@property (nonatomic, readonly, nullable) id<GPTDSChallengeResponseImage> issuerImage;
...
@property (nonatomic, readonly, nullable) NSArray<id<GPTDSChallengeResponseMessageExtension>> *messageExtensions;
...
@property (nonatomic, readonly, nullable) id<GPTDSChallengeResponseImage> paymentSystemImage;
