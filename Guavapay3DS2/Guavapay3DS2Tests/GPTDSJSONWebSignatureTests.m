...
@interface GPTDSJSONWebSignatureTests : XCTestCase

@end

@implementation GPTDSJSONWebSignatureTests
...
- (void)testInitES256 {
    ...
    NSData *signature = [@"71MhQ7FJavv1nQ7Boujfp7K0iBEYFGSGLZ3osnL9KAY9scF95Hf7ZMQ8I1JSgnGl227UY96is80MlbTijOOxsg" _gptds_base64URLDecodedData];
    XCTAssertEqualObjects(jws.signature, signature, @"Parsed signature incorrectly.");
    NSData *payload = [@"eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0" _gptds_base64URLDecodedData];
...
- (void)testInitPS256 {
    ...
    XCTAssertEqual(jws.algorithm, GPTDSJSONWebSignatureAlgorithmPS256, @"Parsed incorrect algorithm");
