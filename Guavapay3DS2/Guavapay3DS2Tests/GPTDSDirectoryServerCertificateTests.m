//
//  GPTDSDirectoryServerCertificateTests.m
//  Guavapay3DS2Tests
//
...
@interface GPTDSDirectoryServerCertificateTests : XCTestCase

@end

@implementation GPTDSDirectoryServerCertificateTests
...
- (void)testCertificateForDirectoryServer {
    ...
    for (NSNumber *directoryServerNum in directoryServers) {
        GPTDSDirectoryServer directoryServer = (GPTDSDirectoryServer)[directoryServerNum integerValue];
        switch (directoryServer) {
            ...
            case GPTDSDirectoryServerVisa:
                XCTAssertNotNil([GPTDSDirectoryServerCertificate certificateForDirectoryServer:directoryServer], @"Failed creating certificate for type %@", directoryServerNum);
                break;
                
            case GPTDSDirectoryServerCustom:
            case GPTDSDirectoryServerUnknown:
                XCTAssertNil([GPTDSDirectoryServerCertificate certificateForDirectoryServer:directoryServer], @"Should return nil for GPTDSDirectoryServerUnknown");
                break;
        }
    }
}
...
- (void)testKeyType {
    ...
    for (NSNumber *directoryServerNum in directoryServers) {
        ...
        switch (directoryServer) {
            case GPTDSDirectoryServerULTestRSA:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Incorrect key type for GPTDSDirectoryServerULTestRSA");
                break;
                
            case GPTDSDirectoryServerULTestEC:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeEC, @"Incorrect key type for GPTDSDirectoryServerULTestEC");
                break;
                
            case GPTDSDirectoryServerSTPTestRSA:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Incorrect key type for GPTDSDirectoryServerSTPTestRSA");
                break;
                
            case GPTDSDirectoryServerSTPTestEC:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeEC, @"Incorrect key type for GPTDSDirectoryServerSTPTestEC");
                break;
                
            case GPTDSDirectoryServerAmex:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Incorrect key type for GPTDSDirectoryServerAmex");
                break;
                
            case GPTDSDirectoryServerCartesBancaires:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Incorrect key type for GPTDSDirectoryServerCartesBancaires");
                break;
                
            case GPTDSDirectoryServerDiscover:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Incorrect key type for GPTDSDirectoryServerDiscover");
                break;
                
            case GPTDSDirectoryServerMastercard:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Incorrect key type for GPTDSDirectoryServerMastercard");
                break;
                
            case GPTDSDirectoryServerVisa:
                XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Incorrect key type for GPTDSDirectoryServerVisa");
                break;
...
- (void)testRSA_OAEP_SHA256Encryption {
    GPTDSDirectoryServerCertificate *certificate = [GPTDSDirectoryServerCertificate certificateForDirectoryServer:GPTDSDirectoryServerSTPTestRSA];
    if (certificate != nil) {
...
- (void)testCustomCertificate {
    ...
    XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Parsed incorrect key type from custom certificate");
}
...
- (void)testCustomCertificateWithString {
    ...
    GPTDSDirectoryServerCertificate *certificate = certificate = [GPTDSDirectoryServerCertificate customCertificateWithString:certificateString];
    XCTAssertNotNil(certificate, @"Failed to create certificate from string.");
    XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Parsed incorrect key type from custom certificate");
    ...
    "udJGOXV9q4VteupwLxfOGW8w\n"
    "-----END CERTIFICATE-----\n";
    certificate = [GPTDSDirectoryServerCertificate customCertificateWithString:certificateString];
    XCTAssertNotNil(certificate, @"Failed to create certificate from string.");
    XCTAssertEqual(certificate.keyType, GPTDSDirectoryServerKeyTypeRSA, @"Parsed incorrect key type from custom certificate");
...
#pragma clang diagnostic pop
    ...
    XCTAssertTrue([GPTDSDirectoryServerCertificate _verifyCertificateChain:certChain withRootCertificates:@[certificateString]], @"Failed to verify certificate chain.");
    certChain = @[@"junk_data", @"more_junk"];
    XCTAssertFalse([GPTDSDirectoryServerCertificate _verifyCertificateChain:certChain withRootCertificates:@[certificateString]], @"Verified certificate chain with invalid certificates.");
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wobjc-string-concatenation"
    ...
    certChain = @[
        ...
        "gd2AJFzXdKLxTt0OYrWDGlUSzGACRBCd5xbRmATIldtccaGqDN1cNWv0I/bPN8EpKS6B"
        "0WaZcPasItKWpDC85Jw1GrDxdhwoKHoxtSG+odiTwB5zLbrn2OsRE5bV7E=",];
    XCTAssertFalse([GPTDSDirectoryServerCertificate _verifyCertificateChain:certChain withRootCertificates:@[certificateString]], @"Verified invalid certificate chain.");
    
    // guavapay.com's cert chain retrieved by https://whatsmychaincert.com/
    // If below test cases start failing, the certs may have expired and should be replaced with newer ones
    // from whatsmychaincert.com, select Generate Cert Chain, include root for guavapay.com
...
#pragma clang diagnostic pop
    ...
    XCTAssertTrue([GPTDSDirectoryServerCertificate _verifyCertificateChain:certChain withRootCertificates:@[rootCertificateString]], @"Failed to verify w/ root certificate.");
    XCTAssertFalse([GPTDSDirectoryServerCertificate _verifyCertificateChain:certChain withRootCertificates:@[dsCertificateString]], @"Should not verify w/ DS certificate.");
    NSArray<NSString *> *bothCertificateStrings = @[dsCertificateString, rootCertificateString];
    XCTAssertTrue([GPTDSDirectoryServerCertificate _verifyCertificateChain:certChain withRootCertificates:bothCertificateStrings], @"Failed to verify w/ root certificate and ds certificate.");
}
...
- (void)testVerifyPS256Signature {
    ...
    GPTDSJSONWebSignature *jws = [[GPTDSJSONWebSignature alloc] initWithString:jwsString];
    ...
    XCTAssertTrue([GPTDSDirectoryServerCertificate verifyJSONWebSignature:jws withRootCertificates:@[certificateString]], @"Failed to validate correct PS256 signature.");
}
...
- (void)testVerifyPS256SignatureFail {
    ...
    XCTAssertFalse([GPTDSDirectoryServerCertificate verifyJSONWebSignature:jws withRootCertificates:@[certificateString]], @"Incorrectly validated PS256 signature.");
}
...
- (void)testVerifyES256Signature {
    ...
    XCTAssertTrue([GPTDSDirectoryServerCertificate verifyJSONWebSignature:jws withRootCertificates:@[certificateString]], @"Failed to verify valid ES256 signature.");
}
...
- (void)testVerifyES256SignatureFail {
    ...
    XCTAssertFalse([GPTDSDirectoryServerCertificate verifyJSONWebSignature:jws withRootCertificates:@[certificateString]], @"Verified invalid ES256 signature.");
}
